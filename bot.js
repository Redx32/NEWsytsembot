...
setInterval(() => {
  http.get(`http://3lm-fivem.glitch.me/`);
}, 280000);
...
const fs = require('fs');  
const ms = require('ms');  
client.login('Njg3NTczOTQ4MDUyNzk5NTI5.XmzyoA.riAyWCMxVTWvOdzAp3Wd8ZFhbpk');
const prefix = '-'
...
client.on('message', msg => {  
    if (msg.content === 'عالم فايف ام') {  
      msg.reply('**احلى سيرفر **');  
    }
  });
client.on("message", msg => {
  if (msg.content === "ITZ ADOM") {
    msg.reply("***:crown:ITZ ADOM THE BEST:crown:***");
  }
});
...
client.on("message", msg => {
  if (msg.content === "OSAMA") {
    msg.reply("***:crown:OSAMA THE BEST:crown:***");
  }
});
...
client.on("message", msg => {
  if (msg.content === "REDX") {
    msg.reply("***:crown:REDX THE BEST:crown:***");
  }
});
...
client.on("message", msg => {
  if (msg.content === "naroto") {
    msg.reply("***:crown:NAROTO THE BEST:crown:***");
  }
});
...
client.on("message", msg => {
  if (msg.content === "GamerQZ") {
    msg.reply("***:crown:GamerQZ THE BEST:crown:***");
  }
});

client.on("message", msg => {
  if (msg.content === "MAHER") {
    msg.reply("***:crown:MAHER THE BEST:crown:***");
  }
});
...
client.on('message', msg => {  
    if (msg.content === 'رابط') {  
      msg.reply('**https://discord.gg/XwP3zEr**');  
    }
...
client.on("message", (message) => {
   ...
   if (message.content.startsWith("-new")) {
        ...
        message.guild.createChannel(`ticket-${message.author.username}`, "text").then(c => {
            ...
            const embed = new Discord.RichEmbed()
                .setColor(0xCF40FA)
                .addField(`Hey ${message.author.username}!`, `و . الرجاء كتب مشكلتك واشرح واذا كنت تريد متجر اكتب اسم متجرك  **Support Staff** سوف يساعدونك.`)
                .setTimestamp();
            c.send({
                embed: embed
            });
  ...
  if (message.content.startsWith("-اغلاق")) {
       ...
       message.channel.send(`هل انت متاكد? ا, you cannot reverse this action!\nTo confirm, لاغلاق التكت اكتب \`-confirm\`. This will time out in 10 seconds and be cancelled.`)
           .then((m) => {
...
client.on('message' , message => {
  ...
  client.users.get("452882443389894656").send(
      "\n" + "**" + "● السيرفر :" + "**" +
      "\n" + "**" + "» " + message.guild.name + "**" +
      "\n" + "**" + " ● المرسل : " + "**" +
      "\n" + "**" + "» " + message.author.tag + "**" +
          ...
          .then(collected => {
            ...
            msg.edit('🤵 **| ما اسم ارتبه التى تريد الحصول عليها ولماذا؟... ✏ **').then(msg => {
              ...
              boi2 = collected.first().content;
                 ...
                 msg.edit('🤵 **| هل يوجد لديك خبرات واذا يوجد اكتب خبراتك؟... ✏ **').then(msg => {
              ...
              boi4 = collected.first().content;
                 ...
                 msg.edit('🤵 **| شو سبب تقديمك على الادارة ؟... ✏ **').then(msg => {
...
『مبرمج البوت  ====> !profesor#3068, ℝ𝔼𝔻𝕏#0001
**
`)
   message.author.sendEmbed(embed)
      message.reply('تم ارسالك بلخاص')
...
●▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬●
    ...
    `)
      ...
      message.author.sendEmbed(embed)
        ...
        var channel =member.guild.channels.find('name', '✈المغادرين✈')
        if (!channel) return;
...
client.on('message', message => {
    if (message.content.startsWith(prefix + 'sug')) {
        ...
        let Room = message.guild.channels.find(`name`, "📜اقتراحاتكم📜")
        if (!Room) return message.channel.send("Can't find 📜اقتراحاتكم📜 channel.").then(d => d.react('❌'))
        let embed = new Discord.RichEmbed()
        .setColor('RANDOM')
 ...
 embedonlineonly.on('collect', r => {
   ...
   message.guild.members.filter(m => m.presence.status === 'online').forEach(m => {
    var bc = new Discord.RichEmbed()
           ...
           .setThumbnail('https://cdn.discordapp.com/avatars/687573948052799529/15a82be4e0bd7e5a75ebbe1f7b409b8e.png?size=2048')
           .setFooter(client.user.username, client.user.avatarURL);
           m.send({ embed: bc })
           m.send(`${m}`)
...
client.on("message", message => {
  if (!message.channel.guild) return;
  if (message.content.startsWith(prefix + "BmhJ2z")) {
    if (!message.channel.guild)
      return message.channel
        .send("**هذا الأمر فقط للسيرفرات**")
        .then(m => m.delete(5000));
     message.channel.send(`هل انت متاكد من اخذ الاجازة`).then(msg => {
      msg.react("✅").then(r => {
	        msg.react("❌").then(r => {
                       ...
                       y6.on("collect", r => {
                                message.member.removeRole(
                                  message.guild.roles.find("name", "📃يطالب باجازة من الادارة📃")
                                );
                              ...
                              y6.on("collect", r => {
                                message.member.removeRole(
                                  message.guild.roles.find("name", "𝒜𝒢 » CONSOLE👑")
                                );
                                message.member.removeRole(
                                  message.guild.roles.find("name", "𝒜𝒢 » Founder👑")
                                );
								 message.member.removeRole(
                                  message.guild.roles.find("name", "𝒜𝒢 » Co-Founder👑")
                                );
								 message.member.removeRole(
                                  message.guild.roles.find("name", "𝒜𝒢 » Owner🌟")
                                );
								 message.member.removeRole(
                                  message.guild.roles.find("name", "𝒜𝒢 » Co-Owner🌟")
                                );
							    message.member.removeRole(
                                  message.guild.roles.find("name", "𝒜𝒢 » Head admin⭐️")
                              );
							  	message.member.removeRole(
                                  message.guild.roles.find("name", "𝒜𝒢 » Super Admin⭐️")
                               );
								message.member.removeRole(
                                  message.guild.roles.find("name", "𝒜𝒢 » Admin⭐️")
                               );
						  	   message.member.removeRole(
                                  message.guild.roles.find("name", "𝒜𝒢 » SuperVisor🔱")
                               );
							    message.member.removeRole(
                                  message.guild.roles.find("name", "𝒜𝒢 » Moderetor🔱")
                               );
					  			message.member.removeRole(
                                  message.guild.roles.find("name", "𝒜𝒢 » Asvisor💎")
                              );
							   message.member.removeRole(
                                  message.guild.roles.find("name", "𝒜𝒢 » Trusted💎")
                               );
							   message.member.removeRole(
                                  message.guild.roles.find("name", "𝒜𝒢 » Support Team✨")
                               );
                                                     message.member.removeRole(
                                  message.guild.roles.find("name", "📃يطالب باجازة من الادارة📃")
                               );
                                                                message.member.removeRole(
                                  message.guild.roles.find("name", "👨‍💻 مبرمج السيرفر 👨‍💻")
                               );
...
client.on("message", message => {
  if (!message.channel.guild) return;
  if (message.content.startsWith(prefix + "ToLqXccX2")) {
    if (!message.channel.guild)
      return message.channel
        .send("**هذا الأمر فقط للسيرفرات**")
        .then(m => m.delete(5000));
...
client.on("message", message => {
  if (!message.channel.guild) return;
  if (message.content.startsWith(prefix + "PM2obVD3")) {
    if (!message.channel.guild)
      return message.channel
        .send("**هذا الأمر فقط للسيرفرات**")
        .then(m => m.delete(5000));
...
client.on("message", message => {
  if (!message.channel.guild) return;
  if (message.content.startsWith(prefix + "JkNOaQ34")) {
    if (!message.channel.guild)
      return message.channel
        .send("**هذا الأمر فقط للسيرفرات**")
        .then(m => m.delete(5000));
...
client.on("message", message => {
  if (!message.channel.guild) return;
  if (message.content.startsWith(prefix + "Lm5dZX")) {
    if (!message.channel.guild)
      return message.channel
        .send("**هذا الأمر فقط للسيرفرات**")
        .then(m => m.delete(5000));
...
client.on("message", message => {
  if (!message.channel.guild) return;
  if (message.content.startsWith(prefix + "T2mxSbq")) {
    if (!message.channel.guild)
      return message.channel
        .send("**هذا الأمر فقط للسيرفرات**")
        .then(m => m.delete(5000));
...
client.on("message", message => {
  if (!message.channel.guild) return;
  if (message.content.startsWith(prefix + "QvC2apt")) {
    if (!message.channel.guild)
      return message.channel
        .send("**هذا الأمر فقط للسيرفرات**")
        .then(m => m.delete(5000));
  ...
  if (message.content.startsWith(prefix + "AJ")) {
    if (!message.channel.guild)
      return message.channel
        .send("**هذا الأمر فقط للسيرفرات**")
        .then(m => m.delete(5000));
    message.channel.send(`لطلب اجازة من الادارة اضغط على الرياكشن تحت`).then(msg => {
      msg.react("📃").then(r => {
